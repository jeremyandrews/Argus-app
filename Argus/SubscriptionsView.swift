...
struct SubscriptionsView: View {
    ...
    let listOfSubscriptions: [String] = ["Alert: Direct", "Alert: Near", "Apple", "Bitcoins", "Clients", "Drupal", "E-Ink", "EVs", "Global", "LLMs", "Longevity", "Music", "Politics, US", "Politics, Italy", "Politics, World", "Rust", "Space", "Tuscany", "Vulnerability", "Test"]
